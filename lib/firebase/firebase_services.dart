...
Future<void> updateRecipeFavoriteStatus(String recipeNo, bool newFavoriteStatus) async {
  final CollectionReference recipesCollection = database.collection('recipes');
...
Future<void> updateMyRecipeFavoriteStatus(String recipeNo, bool newFavoriteStatus) async {
  final CollectionReference recipesCollection = database.collection('users/mecha/myrecipe');
